...
- New-intent execution integration (durable claim, save receipt and independent readback) remains NEXT; the old executor still requires an existing target. Full adapter/CLI is not implemented by this contract unit.
